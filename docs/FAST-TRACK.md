...
- Every CMS field Conor needs is present and works, including the ones with nothing
  in them yet.
- Every gap is a **visible, labelled placeholder** at the correct dimensions, never a blank space, never a silently collapsed section, never an invented
  substitute.
...
Build all three preview directions at /preview/a, /preview/b and /preview/c, genuinely different designs, not three colourways of one layout.
...
Where it doesn't, structure the section fully and put a labelled placeholder in it, never skip a section because its content hasn't arrived, and never write copy the
