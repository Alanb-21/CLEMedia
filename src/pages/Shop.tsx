      ...
      <Section className="!pb-10">
        <Container>
          <div className="max-w-[44ch]">
            <Kicker>Shop</Kicker>
            <h1 className="mt-5 display-page font-display">Printables and activities</h1>
          </div>
          <Lead className="mt-6">
              ...
              <Settle as="li" key={s.n}>
                <Panel className="h-full p-7 transition-transform duration-300 hover:-translate-y-1">
                  <div className="flex items-center gap-3">
                    <span className="wash-cream hairline-ring flex h-11 w-11 items-center justify-center rounded-[var(--radius-card)] text-red-deep">
                      <s.icon size={21} />
                    </span>
                    <span className="font-display text-[14px] text-clay" aria-hidden="true">{s.n}</span>
                  </div>
                  <h2 className="mt-4 text-[18px] font-semibold">{s.t}</h2>
